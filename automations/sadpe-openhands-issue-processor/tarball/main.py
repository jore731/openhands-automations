...
The script:
  ...
  8. Creates a RemoteConversation and injects secrets
...
Runtime-injected secrets (via the Conversation secrets channel):
...
{USER_PROMPT}"""
    ...
    if len(repo_dirs) != 1:
        raise RuntimeError("OpenCode ACP automation requires exactly one cloned repository")
